...
(function (A04_EinkaufslisteDatenstruktur) {
    ...
    A04_EinkaufslisteDatenstruktur.generateContent = generateContent;
    ...
    A04_EinkaufslisteDatenstruktur.destroyContent = destroyContent;
    function deleteItem() {
        let activeID = parseInt(getButtonID());
        destroyContent(A04_EinkaufslisteDatenstruktur.shoppingList);
        A04_EinkaufslisteDatenstruktur.shoppingList.Liste.splice(activeID, 1);
        generateContent(A04_EinkaufslisteDatenstruktur.shoppingList);
    }
    function updateItem() {
        ...
        A04_EinkaufslisteDatenstruktur.shoppingList.Liste[getButtonID()].quantity = parseInt(newAmountString);
        A04_EinkaufslisteDatenstruktur.shoppingList.Liste[getButtonID()].comment = newCommentString;
        destroyContent(A04_EinkaufslisteDatenstruktur.shoppingList);
        generateContent(A04_EinkaufslisteDatenstruktur.shoppingList);
    }
    function changeItemStatus() {
        ...
        let ActiveID = parseInt(getButtonID());
        if (A04_EinkaufslisteDatenstruktur.shoppingList.Liste[ActiveID].inCart == false && A04_EinkaufslisteDatenstruktur.shoppingList.Liste[ActiveID].bought == false) {
            ActiveButton.classList.add("fa-cart-shopping");
            ActiveButton.classList.remove("fa-circle");
            A04_EinkaufslisteDatenstruktur.shoppingList.Liste[ActiveID].inCart = true;
        }
        else if (A04_EinkaufslisteDatenstruktur.shoppingList.Liste[ActiveID].inCart == true && A04_EinkaufslisteDatenstruktur.shoppingList.Liste[ActiveID].bought == false) {
            ActiveButton.classList.add("fa-check");
            ActiveButton.classList.remove("fa-cart-shopping");
            A04_EinkaufslisteDatenstruktur.shoppingList.Liste[ActiveID].bought = true;
        }
        else {
            ActiveButton.classList.add("fa-circle");
            ActiveButton.classList.remove("fa-check");
            A04_EinkaufslisteDatenstruktur.shoppingList.Liste[ActiveID].inCart = false;
            A04_EinkaufslisteDatenstruktur.shoppingList.Liste[ActiveID].bought = false;
        }
    }
