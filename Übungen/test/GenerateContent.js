...
(function (A06_EinkaufslisteDatenstruktur) {
    ...
    A06_EinkaufslisteDatenstruktur.generateContent = generateContent;
    ...
    A06_EinkaufslisteDatenstruktur.destroyContent = destroyContent;
    function deleteItem() {
        let activeID = parseInt(getButtonID());
        destroyContent(A06_EinkaufslisteDatenstruktur.globalShoppingList);
        A06_EinkaufslisteDatenstruktur.globalShoppingList.List.splice(activeID, 1);
        generateContent(A06_EinkaufslisteDatenstruktur.globalShoppingList);
        A06_EinkaufslisteDatenstruktur.updateJSON();
    }
    function updateItem() {
        ...
        A06_EinkaufslisteDatenstruktur.globalShoppingList.List[getButtonID()].quantity = parseInt(newAmountString);
        A06_EinkaufslisteDatenstruktur.globalShoppingList.List[getButtonID()].comment = newCommentString;
        destroyContent(A06_EinkaufslisteDatenstruktur.globalShoppingList);
        generateContent(A06_EinkaufslisteDatenstruktur.globalShoppingList);
        A06_EinkaufslisteDatenstruktur.updateJSON();
    }
    function changeItemStatus() {
        ...
        let ActiveID = parseInt(getButtonID());
        if (A06_EinkaufslisteDatenstruktur.globalShoppingList.List[ActiveID].inCart == false && A06_EinkaufslisteDatenstruktur.globalShoppingList.List[ActiveID].bought == false) {
            ActiveButton.classList.add("fa-cart-shopping");
            ActiveButton.classList.remove("fa-circle");
            A06_EinkaufslisteDatenstruktur.globalShoppingList.List[ActiveID].inCart = true;
        }
        else if (A06_EinkaufslisteDatenstruktur.globalShoppingList.List[ActiveID].inCart == true && A06_EinkaufslisteDatenstruktur.globalShoppingList.List[ActiveID].bought == false) {
            ActiveButton.classList.add("fa-check");
            ActiveButton.classList.remove("fa-cart-shopping");
            A06_EinkaufslisteDatenstruktur.globalShoppingList.List[ActiveID].bought = true;
        }
        else {
            ActiveButton.classList.add("fa-circle");
            ActiveButton.classList.remove("fa-check");
            A06_EinkaufslisteDatenstruktur.globalShoppingList.List[ActiveID].inCart = false;
            A06_EinkaufslisteDatenstruktur.globalShoppingList.List[ActiveID].bought = false;
        }
        A06_EinkaufslisteDatenstruktur.updateJSON();
    }
